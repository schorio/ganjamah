					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								...
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="/ganjamah/liste/employee/employees.php">Listes des employés</a></li>
									...
									<div class="profile-view">
										<div class="profile-img-wrap">
											<div class="profile-img">
												<a href="#"><img alt="" src="/ganjamah/assets/img/employee/<?php echo $image ?>"></a>
											</div>
										</div>
