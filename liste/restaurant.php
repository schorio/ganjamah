						...
						<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget">
								<div class="profile-img">
									...
									<a href="#"data-toggle="modal" data-target="#voir_restaurant_<?php echo htmlentities($row->id_resto); ?>" class="avatar"><img src="/ganjamah/assets/img/restaurant/<?php echo htmlentities($row->image_resto); ?>" alt="image"></a>
								</div>
