					...
					<div class="page-header">
						<div class="row align-items-center">
							...
							<div class="col-auto float-right ml-auto">
								<a href="#" class="btn add-btn" data-toggle="modal" data-target="#ajouter_hotel"><i class="fa fa-plus"></i> Ajouter un hotel</a>
						...
						<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
							<div class="profile-widget">
								<div class="profile-img">
									...
									<a href="#"data-toggle="modal" data-target="#voir_hotel_<?php echo htmlentities($row->id_hotel); ?>" class="avatar"><img src="/ganjamah/assets/img/hotel/<?php echo htmlentities($row->image_hotel); ?>" alt="image"></a>
								</div>
									<div class="dropdown profile-action">
										<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
										<div class="dropdown-menu dropdown-menu-right">
											<a class="dropdown-item" href="#" data-toggle="modal" data-target="#modifier_hotel_<?php echo htmlentities($row->id_hotel); ?>"><i class="fa fa-pencil m-r-5"></i> Modifier</a>
											<a class="dropdown-item" href="#" data-toggle="modal" data-target="#supprimer_hotel_<?php echo htmlentities($row->id_hotel); ?>"><i class="fa fa-trash-o m-r-5"></i> Supprimer</a>
										</div>
									</div>
								<div>
									<h4 class="user-name m-t-10 mb-0 text-ellipsis"><?php echo htmlentities($row->nom_hotel); ?></h4>
									<h6 class="user-name text-ellipsis"><?php echo htmlentities($row->adresse_hotel); ?></h6>
								</div>
