...
if($_POST["password_ut"] !== $_POST["confirmPassword"]){
    header("Location: /ganjamah/liste/utilisateur/ut.php?message=Ereur de confirmation mot de pass");
}
...
if($result){
    ...
    header("Location: /ganjamah/liste/utilisateur/ut.php?message=$message");
}
...
if(!$result){
    ...
    $message = "Compte créé";
    header("Location: /ganjamah/liste/utilisateur/ut.php?message=$message&type=success");
}
