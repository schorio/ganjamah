    ...
    <body>
        ...
        <header class = "flex header-sm">
            <div class = "container">
                <div class = "header-title">
                    <h1>Restaurant</h1>
                    <p>La liste des restaurants présent à Majunga</p>
                </div>
            </div>
        </header>
        <!-- header -->
        ...
        <section id = "popular" class = "py-4">
            <div class = "title-wrap">
                ...
                <h2 class = "lg-title">Les plus populaires des restaurant</h2>
            </div>
            ...
            <div class = "popular-row">
                ...
                <div class = "popular-item shadow">
                    <img src = "/ganjamah/assets/img/restaurant/<?php echo $row['IMAGE_RESTO']; ?>" alt = "">
                    <div>
                        <span class="titre-1"><?php echo $row['NOM_RESTO']; ?></span><br>
                        <span class="titre-2 text-muted"><?php echo $row['ADRESSE_RESTO']; ?></span>
                        <p class="">
                            <input data-role="rating" data-value="<?php echo $row['NOTE_RESTO']; ?>">
                        </p>
                        <!-- <p class = "text"><php echo $row['DESCRIPTION_RESTO']; ?></p> -->
                    </div>
                </div>
